...
Session: `seer-entity-bank-run-1775369419285`
...
{
  "status": 201,
  "readingId": "24d7ca9c-3c49-4a0a-8823-0c0f26b93af3",
...
### 3. `POST /api/seer/readings/24d7ca9c-3c49-4a0a-8823-0c0f26b93af3/turn`
```json
{
  "status": 200,
...
### 4. `POST /api/seer/readings/24d7ca9c-3c49-4a0a-8823-0c0f26b93af3/turn`
```json
{
  "status": 200,
  "transitionType": "card_reveal",
...
### 5. `POST /api/seer/readings/24d7ca9c-3c49-4a0a-8823-0c0f26b93af3/turn`
```json
{
  "status": 200,
...
### 6. `POST /api/seer/readings/24d7ca9c-3c49-4a0a-8823-0c0f26b93af3/turn`
```json
{
  "status": 200,
...
### 7. `POST /api/seer/readings/24d7ca9c-3c49-4a0a-8823-0c0f26b93af3/cards/seer-card-8e6af435-6fd4-47f7-94b5-f17a39ab19ad/claim`
```json
{
  "status": 200,
...
### 8. `GET /api/entities?linkedReadingId=...`
```json
{
  "status": 200,
  "entityNames": [
...
### 9. `POST /api/sendStorytellerToEntity`
```json
{
  "status": 200,
  "outcome": "success",
...
### 10. `GET /api/immersive-rpg/character-sheet`
```json
{
  "status": 200,
